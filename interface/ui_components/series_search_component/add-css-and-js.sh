...
append_js $sc_web_path/templates/components.html components/js/series_search_component/series_search_component.js
append_css $sc_web_path/templates/components.html components/css/series_search_component.css
