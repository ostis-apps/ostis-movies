...
append_js $sc_web_path/templates/components.html components/js/search_similar_films_component/search_similar_films_component.js
append_css $sc_web_path/templates/components.html components/css/search_similar_films_component.css
