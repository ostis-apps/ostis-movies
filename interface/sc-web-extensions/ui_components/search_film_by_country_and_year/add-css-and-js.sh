...
append_js $sc_web_path/templates/components.html components/js/search_film_by_country_and_year_component/search_film_by_country_and_year_component.js
append_css $sc_web_path/templates/components.html components/css/search_film_by_country_and_year_component.css
