...
append_js $sc_web_path/templates/components.html components/js/series_add_component/series_add_component.js
append_css $sc_web_path/templates/components.html components/css/series_add_component.css
