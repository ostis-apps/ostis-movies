...
filmstudio_js_path=components/js/filmstudio/filmstudio.js
filmstudio_css_path=components/css/filmstudio.css
...
append_js $sc_web_path/templates/components.html $filmstudio_js_path
append_css $sc_web_path/templates/components.html $filmstudio_css_path