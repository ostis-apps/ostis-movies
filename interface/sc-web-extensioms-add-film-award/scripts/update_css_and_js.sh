...
filmaward_js_path=components/js/filmaward/filmaward.js
filmaward_css_path=components/css/filmaward.css
...
append_js $sc_web_path/templates/components.html $filmaward_js_path
append_css $sc_web_path/templates/components.html $filmaward_css_path
