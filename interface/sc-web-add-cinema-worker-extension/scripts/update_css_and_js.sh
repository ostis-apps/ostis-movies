...
employee_js_path=components/js/employee/employee.js
employee_css_path=components/css/employee.css
...
append_js $sc_web_path/templates/components.html $employee_js_path
append_css $sc_web_path/templates/components.html $employee_css_path