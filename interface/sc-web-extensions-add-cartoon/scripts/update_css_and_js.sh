...
cartoon_js_path=components/js/cartoon/cartoon.js
cartoon_css_path=components/css/cartoon.css
...
append_js $sc_web_path/templates/components.html $cartoon_js_path
append_css $sc_web_path/templates/components.html $cartoon_css_path
