...
filmportal_js_path=components/js/filmportal/filmportal.js
filmportal_css_path=components/css/filmportal.css
...
append_js $sc_web_path/templates/components.html $filmportal_js_path
append_css $sc_web_path/templates/components.html $filmportal_css_path
